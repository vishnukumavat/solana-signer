    ...
    <>
      <div className="max-w-7xl mx-auto">
        <AnimatePresence mode="wait">
          {!hasSigned ? (
            <div className={`flex flex-col lg:flex-row gap-6 transition-all duration-300 ${showCodeExamples ? "lg:justify-between" : "lg:justify-center"}`} key="signing-layout">
              <div className="flex-1 lg:max-w-xl">
                <Card key="sign-form" variant="elevated" className="dark:bg-gray-800 bg-white">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    {/* Code examples button - visible on all screens */}
                    <div className="mt-4">
              ...
              <AnimatePresence>
                {showCodeExamples && (
                  <motion.div initial={{ opacity: 0, width: 0 }} animate={{ opacity: 1, width: "600px" }} exit={{ opacity: 0, width: 0 }} transition={{ duration: 0.3 }} className="hidden lg:block h-fit">
            ...
            <div className={`flex flex-col lg:flex-row gap-6 transition-all duration-300 ${showCodeExamples ? "lg:justify-between" : "lg:justify-center"}`} key="results-layout">
              <div className="flex-1 lg:max-w-xl">
